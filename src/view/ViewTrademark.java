...
import service.impl.TrademarkServiceImpl;

/**
 *
 * @author admin
 */
public class ViewTrademark extends javax.swing.JDialog {

    private TrademarkService trademarkService;
    DefaultTableModel defaultTableModel;
    public ViewTrademark(java.awt.Frame parent, boolean modal) {
       super(parent, modal);
        initComponents();
    ...
    private void loadTable(List<Trademark> getList){
        ...
        for (Trademark trademark : getList) {
    ...
    private void btnSaveActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSaveActionPerformed
        ...
        Trademark trademark = getFormData();
        if(trademark == null){
            return;
        }else{
            try {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewTrademark.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        /* Create and display the form */
         java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ViewTrademark dialog = new ViewTrademark(new javax.swing.JFrame(), true);
