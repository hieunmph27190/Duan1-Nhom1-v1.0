 ...
 */
public class QuanLyNhanVienn extends javax.swing.JFrame {

    /**
     * Creates new form QuanLyNhanVienn
     */
    public QuanLyNhanVienn() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(QuanLyNhanVienn.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new QuanLyNhanVienn().setVisible(true);
            }
        });
    }
